...
public class Game {
    ...
    public Game(int boardSize, ArrayList<Checker> reds, ArrayList<Checker> blacks) {
        blackPoints = 0;
        redPoints = 0;
        this.reds = reds;
        this.blacks = blacks;
        state = new GameState(boardSize, reds, blacks);
    }

    public ArrayList<Checker> getBlacks() { return blacks; }
